% =========================================================================
% Title: Code to demo gtvMVO method using Samson data
...
fname = fullfile(resultsFolder,'samson_output.mat');

%% Load Samson dataset
load('data/samson/samson_1.mat');
load('data/samson/end3.mat');
...
para_mbo.itermax = 30;
para_mbo.dt = 0.01;
para_mbo.lambda = 10^(-3.75);
para_mbo.rho = 10^(-2.25);
para_mbo.gamma = 10^4;
...
para_mbo_fixed.itermax = 30;
para_mbo_fixed.lambda = 10^(-3.5);
...
saveas(fig, fullfile(resultsFolder,'samsonResultsA.jpg'));
